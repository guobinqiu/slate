...
class GmoMemberListCSVCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            $output->writeln(date('Y-m-d H:i:s') . ' member_list file created. ' . $filepath . '/' . $filename);
            ...
            $output->writeln(date('Y-m-d H:i:s') . ' member_list file compressed. ' . $filepath . '/' . $filename . '.zip');
        } catch (\Exception $e) {
