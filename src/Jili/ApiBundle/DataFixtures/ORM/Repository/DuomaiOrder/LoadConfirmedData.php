...
class LoadConfirmedData extends AbstractFixture implements  FixtureInterface 
{
    ...
    */
    public function load(ObjectManager $manager) 
    {
        ...
        $r3 = $manager->getConnection()->query("INSERT INTO task_history05 (id, order_id, user_id, task_type, category_type, task_name, reward_percent, point, ocd_created_date, date, status) VALUES (1 , 1, '105', 8, 23, '购物返利', 70, 378, '2015-04-27 11:58:32', '2015-04-27 11:58:32', 2)");
        $r3->closeCursor();
