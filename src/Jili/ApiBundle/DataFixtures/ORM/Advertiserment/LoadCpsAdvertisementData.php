...
class LoadCpsAdvertisementData extends AbstractFixture implements ContainerAwareInterface,  FixtureInterface, OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $sql = file_get_contents($fixture_dir.DIRECTORY_SEPARATOR.'cps_advertisement.sql');
