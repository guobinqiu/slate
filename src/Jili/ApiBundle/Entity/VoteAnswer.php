 ...
 * VoteAnswer
 *
 * @ORM\Table(name="vote_answer", uniqueConstraints={@ORM\UniqueConstraint(name="user_id", columns={"user_id", "vote_id"})}, indexes={@ORM\Index(name="vote_id", columns={"vote_id"})})
 * @ORM\Entity(repositoryClass="Jili\ApiBundle\Repository\VoteAnswerRepository")
 */
class VoteAnswer
{
    /**
