...
class DuomaiOrder
{
     ...
     * @var float
     *
     * @ORM\Column(name="orders_price", type="float", options={"default": 0, "comment": "订单金额"})
     */
    private $ordersPrice;
     ...
     * @var float
     *
     * @ORM\Column(name="comm", type="float", options={"default": 0, "comment": "siter_commission 订单佣金"})
     */
    private $comm;
     ...
     * @var integer
     *
     * @ORM\Column(name="status", type="integer", options={"default": 0, "comment": "订单状态  -1 无效 0 未确认 1 确认 2 结算"})
     */
    private $status;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="deactivated_at", type="datetime", options={"comment": "status= -1 的时间", "default": "0000-00-00 00:00:00"})
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="confirmed_at", type="datetime", options={"comment": "status= 1 的时间", "default": "0000-00-00 00:00:00"})
     */
    private $confirmedAt;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="balanced_at", type="datetime", options={"comment": "status= 2 的时间", "default": "0000-00-00 00:00:00"})
     */
    private $balancedAt;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="created_at", type="datetime", options={"comment": "status= 0 的时间", "default": "0000-00-00 00:00:00"})
     */
    private $createdAt;
