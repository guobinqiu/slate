...
class TaoBaoLoginControllerTest extends WebTestCase
{
    ...
    public function setUp()
    {
        ...
        $tn = $this->getName();
        // load fixtures
        if( in_array($tn , array('testCallBackAction','testCallBackActionI','testCallBackActionII','testCallBackActionIII','testCallBackActionIV'))) {
    ...
    public function testCallBackActionI()
    {
       ...
       $client->getContainer()->set('user_TaoBao_login', $mockTaoBaoAuth);
