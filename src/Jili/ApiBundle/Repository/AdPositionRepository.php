...
class AdPositionRepository extends EntityRepository
{
    ...
    {
        $query = $this->createQueryBuilder('ap');
        $query = $query->select('ap.id as aid,ap.type,ap.position,ap.adId,a.id,a.title,a.decription,a.content,a.imageurl,a.iconImage,
        a.listImage,a.incentiveType,a.incentiveRate,a.incentive,a.info');
