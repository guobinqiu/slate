 ...
 *
 * @Route("/admin/emar/websites")
 */
class EmarWebsitesController extends Controller
{
    /**
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JiliEmarBundle:EmarWebsites')->findAll();
     ...
     * @Method("PUT")
     * @Template("JiliEmarBundle:EmarWebsites:edit.html.twig")
     */
