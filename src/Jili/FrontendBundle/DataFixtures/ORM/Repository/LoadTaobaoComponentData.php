...
class LoadTaobaoComponentData extends AbstractFixture implements ContainerAwareInterface, FixtureInterface{
    ...
    */
    public function load(ObjectManager $manager) {
        ...
        $file = $fixture_dir.DIRECTORY_SEPARATOR. 'taobao_component.sql';
