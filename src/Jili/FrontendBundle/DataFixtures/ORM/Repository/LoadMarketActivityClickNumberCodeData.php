...
class LoadMarketActivityClickNumberCodeData extends AbstractFixture implements ContainerAwareInterface, FixtureInterface{
    ...
    */
    public function load(ObjectManager $manager) {
        ...
        $file = $fixture_dir.DIRECTORY_SEPARATOR. 'market_activity_click_number.sql';
