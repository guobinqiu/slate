...
table {
    ...
    pk 'id';
    columns({ name => 'id', type => 4 }, { name => 'category', type => 12 },);
};
...
table {
    name 'cb_category';
    pk 'id';
    columns({ name => 'id', type => 4 }, { name => 'category_name', type => 12 },);
};
...
table {
    name 'hobby_list';
    pk 'id';
    columns({ name => 'id', type => 4 }, { name => 'hobby_name', type => 12 },);
};
...
table {
    ...
    columns({ name => 'source_job_id', type => 4 }, { name => 'dest_job_id', type => 4 },);
};
...
table {
    name 'month_income';
    pk 'id';
    columns({ name => 'id', type => 4 }, { name => 'income', type => 12 },);
};
...
table {
    name 'point_reason';
    pk 'id';
    columns({ name => 'id', type => 4 }, { name => 'reason', type => 12 },);
};
...
table {
    ...
    pk 'id';
    columns({ name => 'id', type => 4 }, { name => 'type', type => 12 },);
};

table {
    name 'provinceList';
    pk 'id';
    columns({ name => 'id', type => 4 }, { name => 'provinceName', type => 12 },);
};
