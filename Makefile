...
create-dir:
	mkdir -p app/{cache,cache_data,logs,logs_data,sessions} web/images/actionPic web/uploads/tmp web/uploads/experience_advertisement web/uploads/vote_image web/uploads/user
...
fix-perms:
	@if [ "$(USER)" = "vagrant" ] || [ "$(USER)" = "ubuntu" ] ; then \
		sudo setfacl -R -m u:"${APACHEUSER}":rwX -m u:${USER}:rwX app/{cache,cache_data,logs,logs_data,sessions} web/images/actionPic web/uploads/tmp web/uploads/experience_advertisement web/uploads/vote_image web/uploads/user /data/91jili/logs/admin ; \
		sudo setfacl -dR -m u:"${APACHEUSER}":rwX -m u:${USER}:rwX app/{cache,cache_data,logs,logs_data,sessions} web/images/actionPic web/uploads/tmp web/uploads/experience_advertisement web/uploads/vote_image web/uploads/user /data/91jili/logs/admin ; \
	else \
		sudo chgrp -R apache app/{cache,cache_data,logs,logs_data,sessions} web/images/actionPic web/uploads/tmp web/uploads/experience_advertisement web/uploads/vote_image web/uploads/user /data/91jili/logs/admin ; \
		sudo chmod -R g+w app/{cache,cache_data,logs,logs_data,sessions} web/images/actionPic web/uploads/tmp web/uploads/experience_advertisement web/uploads/vote_image web/uploads/user /data/91jili/logs/admin ; \
	fi;
...
fix-777:
	sudo chgrp -R apache app/{cache,cache_data,logs,logs_data,sessions} web/images/actionPic web/uploads/tmp web/uploads/experience_advertisement web/uploads/vote_image web/uploads/user /data/91jili/logs/admin
	sudo chmod -R 777  app/{cache,cache_data,logs,logs_data,sessions} web/images/actionPic web/uploads/tmp web/uploads/experience_advertisement web/uploads/vote_image web/uploads/user /data/91jili/logs/admin
