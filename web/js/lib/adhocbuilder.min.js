...
!function(adhoc,document,window,undefined){"use strict";function _get_major_minor(a){if(!a)return"";var b=a.split("."),c="";return b.length>0&&(c+=b[0]),b.length>1&&(c+="."+b[1]),c}var protocol="https:"===window.location.protocol?"https:":"http:",ADHOC_GETFLAGS_URL=protocol+"//experiment.appadhoc.com/get_flags_async",ADHOC_FORCEEXP_URL=protocol+"//experiment.appadhoc.com/force_clients",ADHOC_TRACKING_URL=protocol+"//tracker.appadhoc.com/tracker",SDK_PREVIEW_MODE=1,SDK_DEFAULT_MODE=0,JSON=JSON||{},timeout=0,oFlagDef={},getFlagsCallback=null,getFlagsCallbackError=null,getExpsCallback=null,getExpsCallbackError=null,query_started=!1,expCookieName=null,cachedStats=[],noStorage=!1,experimentStatus=0,allowingSpider=!1,sdkMode=SDK_DEFAULT_MODE,forceQrcode="";Date.now=Date.now||function(){return(new Date).getTime()},JSON.stringify=JSON.stringify||function(a){var b=typeof a;if("object"!=b||null===a)return"string"==b&&(a='"'+a+'"'),String(a);var c,d,e=[],f=a&&a.constructor==Array;for(c in a)d=a[c],b=typeof d,"string"==b?d='"'+d+'"':"object"==b&&null!==d&&(d=JSON.stringify(d)),"function"!=b&&e.push((f?"":'"'+c+'":')+String(d));return(f?"[":"{")+String(e)+(f?"]":"}")},JSON.parse=JSON.parse||function(str){return eval("("+str+")")};var getCookie=function(a){for(var b=encodeURIComponent(a),c=b+"=",d=document.cookie.split(";"),e=0;e<d.length;e++){for(var f=d[e];" "==f.charAt(0);)f=f.substring(1);if(0===f.indexOf(b)){var g=f.substring(c.length,f.length);return decodeURIComponent(g)}}return null},setCookie=function(a,b,c){var d="";if(c)var e=new Date(Date.now()+24*c*60*60*1e3),d="; expires="+e.toUTCString();var f=encodeURIComponent(a)+"="+encodeURIComponent(b)+d+"; path=/";document.cookie=f},getStorageItem=function(a){var b=window.localStorage;return b?b.getItem(a):getCookie(a)},setStorageItem=function(a,b){var c=window.localStorage;c?c.setItem(a,b):setCookie(a,b)},getCachedFlags=function(){return thisAdhoc.cachedFlags||noStorage||_updateCachedFlags(),thisAdhoc.cachedFlags},_updateCachedFlags=function(a){var b="ADHOC_FLAGS_"+thisAdhoc.ak;a?setStorageItem(b,a):a=getStorageItem(b);var c=a?JSON.parse(a):{};for(var d in c)"_http"==d.substr(0,5)&&"_"==d.substr(d.length-1)&&"string"==typeof c[d]&&(c[d]=decodeURIComponent(c[d]));thisAdhoc.cachedFlags=c},getCachedExperiments=function(){return thisAdhoc.cachedExps||noStorage||_updateCachedExps(),thisAdhoc.cachedExps},getCachedExperiments4Stat=function(){return thisAdhoc.experiments||noStorage||_updateCachedExps(),thisAdhoc.experiments},_updateCachedExps=function(a){var b="ADHOC_EXPERIMENTS_"+thisAdhoc.ak;a?setStorageItem(b,a):a=getStorageItem(b);var c=[],d=[];a&&(d=a.split(",")),d.forEach(function(a){var b=a.indexOf(":"),d=a.substr(0,b),e=a.substr(b+1);d&&e&&c.push({id:d,name:e})}),thisAdhoc.cachedExps=c,thisAdhoc.experiments=[],c.forEach(function(a){thisAdhoc.experiments.push(a.id)})},_scanMode=function(){forceQrcode=_getQueryString("adhoc_force_qrcode"),forceQrcode&&(sdkMode=SDK_PREVIEW_MODE)},_isPreviewMode=function(){return sdkMode===SDK_PREVIEW_MODE},_initPreviewMode=function(){var a=getCookie("ADHOC_EXPERIMENT_QRCODE");a!==forceQrcode&&_alert("确认后,将刷新页面并且强制进入实验版本",function(){thisAdhoc.forceExperiment(forceQrcode,function(){setCookie("ADHOC_EXPERIMENT_QRCODE",forceQrcode,36e3),window.location.reload()})})},_getQueryString=function(a){var b=new RegExp("(^|&)"+a+"=([^&]*)(&|$)"),c=window.location.search.substr(1).match(b);return c?decodeURI(c[2]):null},_alert=function(a,b){return alert(a),b()},_getsummary=function(){var a=new UAParser,b=a.getResult(),c=navigator.language||navigator.browserLanguage||navigator.systemLanguage||navigator.userLanguage||"",d="",e="",f=c.indexOf("-");if(f>0&&(d=c.substr(f+1).toUpperCase(),c=c.substr(0,f),e=c+"_"+d),"iOS"==b.os.name?b.os.name="iPhone OS":"Android"==b.os.name?b.os.name="google_android":"Windows"==b.os.name&&"mobile"!=b.device.type?b.device.type="PC":"Mac OS"==b.os.name&&"mobile"!=b.device.type&&(b.device.type="Mac"),"Mobile Safari"==b.browser.name?b.browser.name="Safari":"IEMobile"==b.browser.name?b.browser.name="IE":"Opera Mini"==b.browser.name&&(b.browser.name="Opera"),thisAdhoc.summary={sdk_api_version:"2.0",sdk_version:"2.1.0",OS:b.os.name||"",os_version:_get_major_minor(b.os.version),os_version_name:b.os.version||"",device_model:b.device.model||navigator.platform||"",country:d,language:c,locale:e,display_height:window.innerHeight||document.documentElement.clientHeight,display_width:window.innerWidth||document.documentElement.clientWidth,device_type:b.device.type||"",device_vendor:b.device.vendor||"",url:window.location.href,referrer:document.referrer,browser:b.browser.name||"",browser_version:_get_major_minor(b.browser.version),browser_version_name:b.browser.version||"",browser_engine:b.engine.name||""},!b.browser.name||!b.browser.version||!b.engine.name){var g=b.ua.match(/(bot|crawl|slurp|spider)/i);g&&(thisAdhoc.summary.browser="__spider__")}},_getexpflags=function(){if(!query_started){var a={app_key:thisAdhoc.ak,client_id:thisAdhoc.c,summary:thisAdhoc.summary,custom:thisAdhoc.customs};query_started=!0,AJAX(ADHOC_GETFLAGS_URL,a,_getflags_handler,_getflags_error_handler)}},_incrementStatArray=function(a,b,c){var d={app_key:thisAdhoc.ak,client_id:thisAdhoc.c,summary:thisAdhoc.summary,custom:thisAdhoc.customs,stats:b};AJAX(ADHOC_TRACKING_URL,d,null,c)},_incrementStat=function(a,b,c,d){var e={key:b,value:c,timestamp:Math.round(Date.now()/1e3),experiment_ids:a},f=[e];_incrementStatArray(a,f,d)},_getflags_error_handler=function(a){"function"==typeof getFlagsCallback&&(getFlagsCallback(oFlagDef,!0),getFlagsCallback=null),"function"==typeof getFlagsCallbackError&&(getFlagsCallbackError(a),getFlagsCallbackError=null),"function"==typeof getExpsCallbackError&&(getExpsCallbackError(a),getExpsCallbackError=null)},_getflags_handler=function(a){query_started=!1;var b=JSON.parse(a);if(b.flags){var c=JSON.parse(a);for(var d in c.flags)"_http"==d.substr(0,5)&&"_"==d.substr(d.length-1)&&"string"==typeof c.flags[d]&&(c.flags[d]=encodeURIComponent(c.flags[d]));_updateCachedFlags(JSON.stringify(c.flags))}var e=[];if(b.experiments){var f="";b.experiments.forEach(function(a){a.name||(a.name=a.id),e.push(a.id),f.length>0&&(f+=","),f+=a.id+":"+a.name}),_updateCachedExps(f),_incrementStat(e,"Event-GET_EXPERIMENT_FLAGS",1,function(a){console.log(a)}),expCookieName&&setCookie(expCookieName,f)}"function"==typeof getFlagsCallback&&(getFlagsCallback(b.flags),getFlagsCallback=null),"function"==typeof getExpsCallback&&(getExpsCallback(e),getExpsCallback=null)},AJAX=function(a,b,c,d){function e(a){if("function"==typeof d)return void d(a,f.status);throw new Error(a)}a=a||"",b=b||{};var f=new XMLHttpRequest;return f.onload=function(){"function"==typeof c&&c(this.responseText)},f.onerror=function(){e(this.responseText)},"withCredentials"in f?(f.open("POST",a,!0),f.setRequestHeader("Content-Type","application/json;charset=UTF-8")):"undefined"!=typeof XDomainRequest&&(f=new XDomainRequest,f.onload=function(){"function"==typeof c&&c(this.responseText)},f.open("POST",a)),b.app_key?(f.timeout=timeout,f.ontimeout=function(){e("timeout")},void f.send(JSON.stringify(b))):void e("Please pass parameters in the init method")},thisAdhoc=adhoc;thisAdhoc.summary={},thisAdhoc.customs={},thisAdhoc.setCustomTagsWithCookies=function(a){if(!(experimentStatus>0))for(var b={},c=0;c<a.length;c++)b[c]=getCookie(a[c]),thisAdhoc.customs[a[c]]=b[c]};var _getUrlAllParams=function(){var a=window.location.search,b={};if(-1!=a.indexOf("?"))for(var c,d=a.replace(/^\?/,"").split("&"),e=d.length,f=0;e>f;f++)d[f]&&(c=d[f].split("="),b[c[0]]=c[1]);return b};thisAdhoc.setCustomTagsWithQueryParams=function(a){if(!(experimentStatus>0))for(var b=_getUrlAllParams(),c=0;c<a.length;c++){var d=a[c];for(var e in b)e===d&&(thisAdhoc.customs[d]=b[e])}},thisAdhoc.setCustomTagsWithAllQueryParams=function(){if(!(experimentStatus>0)){var a=window.location.search;if(-1!=a.indexOf("?"))for(var b,c=a.replace(/^\?/,"").split("&"),d=c.length,e=0;d>e;e++)c[e]&&(b=c[e].split("="),thisAdhoc.customs[b[0]]=b[1])}},thisAdhoc.setCustomTags=function(a){if(!(experimentStatus>0))for(var b in a)thisAdhoc.customs[b]=a[b]},thisAdhoc.setTimeout=function(a){experimentStatus>0||(timeout=a)},thisAdhoc.setFlagDef=function(a){if(!(experimentStatus>0))for(var b in a)oFlagDef[b]=a[b]},thisAdhoc.setSavingExpsToCookie=function(a){experimentStatus>0||(expCookieName=a)},thisAdhoc.setAllowSpider=function(a){allowingSpider=a};var _generateClientId=function(){function a(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()};thisAdhoc.getClientId=function(){return thisAdhoc.c},thisAdhoc.initSplit=function(a,b){if(!a)throw new Error("Needs an appKey, get it from web console please!");if(!b)throw new Error("Needs an clientId!");return _getsummary(),allowingSpider||"__spider__"!=thisAdhoc.summary.browser?(thisAdhoc.ak=a,thisAdhoc.c=b,void(noStorage=!0)):void(experimentStatus=3)},thisAdhoc.init=function(a,b){if(!a)throw new Error("Needs an appKey, get it from web console please!");if(thisAdhoc.ak=a,_getsummary(),!allowingSpider&&"__spider__"==thisAdhoc.summary.browser)return void(experimentStatus=3);_scanMode();var c=getCookie("ADHOC_MEMBERSHIP_CLIENT_ID");(null==c||b&&b!=c)&&(c=b||_generateClientId(),setCookie("ADHOC_MEMBERSHIP_CLIENT_ID",c,365)),thisAdhoc.c=String(c),_isPreviewMode()&&_initPreviewMode(),_getexpflags()},thisAdhoc.getCachedExperimentFlags=function(){return experimentStatus>0?void 0:getCachedFlags()},thisAdhoc.getExperimentFlags=function(a,b){if(experimentStatus>0)return void("function"==typeof b&&b("spider"));if(_isPreviewMode())return thisAdhoc.getExperimentFlagsDirect(a);var c=getCachedFlags();return c&&Object.keys(c).length>0&&"function"==typeof a?void a(c):("function"==typeof a&&(getFlagsCallback=a),"function"==typeof b&&(getFlagsCallbackError=b),void _getexpflags())},thisAdhoc.getExperimentFlagsRemote=function(a,b){return experimentStatus>0?void("function"==typeof b&&b("spider")):(getFlagsCallback=function(b,c){"function"==typeof a&&(c&&(b=getCachedFlags()||b),a(b))},"function"==typeof b&&(getFlagsCallbackError=b),void _getexpflags())},thisAdhoc.getExperimentFlagsDirect=function(a){if(!(experimentStatus>0)){var b={app_key:thisAdhoc.ak,client_id:thisAdhoc.c,summary:thisAdhoc.summary,custom:thisAdhoc.customs};AJAX(ADHOC_GETFLAGS_URL,b,function(b){var c=JSON.parse(b);if(c){thisAdhoc.cachedFlags=c.flags;var d=[];c.experiments&&c.experiments.forEach(function(a){a.name||(a.name=a.id),d.push(a.id)}),thisAdhoc.experiments=d,thisAdhoc.cachedExps=d,a&&a(thisAdhoc.cachedFlags,thisAdhoc.cachedExps)}})}},thisAdhoc.getExperiments=function(a,b){if(experimentStatus>0)return void("function"==typeof b&&b("spider"));var c=getCachedExperiments();return c&&c.length>0&&"function"==typeof a?void a(c):("function"==typeof a&&(getExpsCallback=a),"function"==typeof b&&(getExpsCallbackError=b),void _getexpflags())},thisAdhoc.incrementStat=function(a,b,c){if(!(experimentStatus>0)){var d=getCachedExperiments4Stat();d&&d.length>0?(cachedStats.length>0&&(cachedStats.forEach(function(a){a.experiment_ids=d}),_incrementStatArray(d,cachedStats,function(){cachedStats=[]})),_incrementStat(d,a,b,c)):cachedStats.push({stat:a,value:b,timestamp:Math.round(Date.now()/1e3)})}},thisAdhoc.incrementStatDirect=function(a,b,c){_incrementStat(thisAdhoc.experiments,a,b,c)},thisAdhoc.forceExperiment=function(a,b,c){if(!(experimentStatus>0)){var d={client_id:thisAdhoc.c,qr_code:a,app_key:thisAdhoc.ak};AJAX(ADHOC_FORCEEXP_URL,d,b,c)}}}(window.adhoc="undefined"!=typeof Object.create?Object.create(null):{},document,window);


!function(a,b,c,d){"use strict";var e=a,f=c.adhoc,g=function(){var a=b.createElement("style"),c="body{opacity:0 !important; filter:alpha(opacity=0) !important; background:none !important;}",d=b.getElementsByTagName("head")[0];a.setAttribute("id","_adhoc_ab_overlay_"),a.setAttribute("type","text/css"),a.styleSheet?a.styleSheet.cssText=c:a.appendChild(b.createTextNode(c)),d.appendChild(a),setTimeout(h,4e3)},h=function(){var a=b.getElementById("_adhoc_ab_overlay_");a&&a.parentNode.removeChild(a)};g(),e.ready=function(a){setTimeout(function(){return"complete"===b.readyState?a():e.ready(a)})},e.init=function(a,b,c,d){e.splitMode=d,e.isPreview=c,e.splitMode||e.isPreview?(f.initSplit(a,b),f.getExperimentFlagsDirect(i)):(f.init(a,b),f.getExperimentFlags(i))};var i=function(a){if(!a)return h();var d=null;if(e.splitMode){if(!b.referrer)return;d=b.referrer,d=d.slice(0,d.indexOf("?"))}else{var g=c.location,i=g.protocol||"http";d=i+"//"+g.host+g.port+g.pathname}var m="_"+encodeURIComponent(d)+"_",n=null;if(a[m]&&(n=m),!n)return h();var o=a[n],p=JSON.parse(o);if(e.splitMode)e.ready(function(){k(p),j()});else{if(p.newPageUrl&&"http"==p.newPageUrl.substr(0,4)){var q=p.newPageUrl;return q.indexOf("?")<0?q+="?":q.indexOf("=")>0&&(q+="&"),q+="__adhoc_split_id__="+f.getClientId(),void(c.location=q)}e.ready(function(){l(p),j()})}},j=function(){f.incrementStatDirect("Event-GET_EXPERIMENT_FLAGS",1)},k=function(a){var b=a.stats;for(var c in b){var d=b[c];q({id:c,stats:d})}},l=function(a){var b=a.style;for(var c in b){var d=b[c];m({id:c,style:d})}var e=a.stats;for(var c in e){var d=e[c];q({id:c,stats:d})}var f=a.img;for(var c in f){var d=f[c];n({id:c,img:d})}var g=a.text;for(var c in g){var d=g[c];o({id:c,text:d})}var i=a.link;for(var c in i){var d=i[c];p({id:c,link:d})}h()},m=function(a){var b=e.$(a.id);b&&b.setAttribute("style",a.style)},n=function(a){var b=e.$(a.id);b&&b.setAttribute("src",a.img)},o=function(a){var b=e.$(a.id);b&&(b.innerText=a.text)},p=function(a){var b=e.$(a.id);b&&(b.href=a.link)},q=function(a){var b=e.$(a.id);b&&s(b,"click",function(){for(var b in a.stats){var c=a.stats[b];f.incrementStatDirect(c,1)}})};e.$=function(a){for(var c=t(a),d=b.body,e=0;e<c.length;e++){var f=c[e];if("body"!==f.name){var g=r(d.childNodes,f.name);if(d=g[f.index],!d)return null}}return d};var r=function(a,b){for(var c=[],d=0;d<a.length;d++){var e=a[d];1===e.nodeType&&e.nodeName==b.toUpperCase()&&c.push(e)}return c},s=function(a,b,c,d,e,f){var g=a,h=f?f:!1,i=null;e&&(g=e===!0?d:e),i=function(){return c.call(g)};try{a.addEventListener(b,i,h)}catch(j){try{a.attachEvent("on"+b,i)}catch(k){a["on"+b]=i}}},t=function(a){for(var b=[],c=a.split("/"),d=1;d<c.length;d++){var e=c[d],f=e.substr(0,e.indexOf("[")),g=parseInt(e.substr(e.indexOf("[")+1,e.length));b.push({name:f,index:g})}return b}}(window.adhocBuilder="undefined"!=typeof Object.create?Object.create(null):{},document,window);


!function(){var a={isIframe:function(){return window.location!=window.parent.location},initEditor:function(a){var b=document.createElement("script");b.src="//h5.appadhoc.com/static/js/adhoc.editor.js?v="+(new Date).getTime(),window._adhoc_md5_=a;var c=document.getElementsByTagName("head")[0];c.appendChild(b)},init:function(b){var c=a;if(c.isIframe())adhocBuilder.ready(function(){c.initEditor(b)});else{var d=!1,e=!1,f=c.getQueryString("__adhoc_split_id__");f?e=!0:(f=c.getQueryString("adhoc_force_client_id"),f&&(d=!0)),adhocBuilder.init(b,f,d,e)}},getQueryString:function(a){var b=new RegExp("(^|&)"+a+"=([^&]*)(&|$)"),c=window.location.search.substr(1).match(b);return null!=c?decodeURI(c[2]):null}};window.__adhoc__=a}();