...
DROP DATABASE IF EXISTS `zili_mig`;

--
-- 数据库: `zili_mig`
--
CREATE DATABASE IF NOT EXISTS `zili_mig` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `zili_mig`;
...
LOAD DATA INFILE '/data/91jili/merge/export/m_u.csv' 
INTO TABLE user 
CHARACTER SET UTF8  
FIELDS  TERMINATED BY ','  
OPTIONALLY ENCLOSED BY '"' 
